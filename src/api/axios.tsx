...
export const API_URI_ROOT = 'https://dev-front.formationbtp.fr/'

// export const API_URI_UPLOAD = 'https://127.0.0.1:8000/uploads/'
export const API_URI_UPLOAD = 'https://dev-front.formationbtp.fr/uploads/'

// export const API_URI_IMAGES = 'https://127.0.0.1:8000/images/'
export const API_URI_IMAGES = 'https://dev-front.formationbtp.fr/images/'
